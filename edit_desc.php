...
<div class="navbar navbar-inverse navbar">
      ...
      <li class="active"><a href="pesq_eqp.php">Voltar</a></li>
 ...
 <span><strong>EDITAR EQP</strong></span>
  ...
  <form class="form" role="form" id="form" name="seachform" method="post" action="enviar_edit_eqp.php " >

  <input type="hidden" class="form-control"   value="<?php echo $serial;?>" name="serial"    required >



  <div class="form-group">  
    <label for="email" >STATUS:</label> <br>
    <select  name="status" class="form-control" required select >
